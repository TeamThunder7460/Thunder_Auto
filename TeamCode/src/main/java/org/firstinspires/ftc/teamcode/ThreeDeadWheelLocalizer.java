...
public final class  ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 10582.831045945113; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -11827.612564850891; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -14629.184216407419; // x position of the perpendicular encoder (in tick units)
    }
